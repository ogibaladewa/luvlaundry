            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel-content">
                        ...
                        &nbsp;
                                <form action="/penggunaan/laporan/penggunaan2" method="GET">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Tahun</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button style="float:right; margin-right:5px;"  onclick="exportToExcel('exportDataPenggunaan', 'LaporanPenggunaanPerKategoriTahun_{{$tahun_id}}')" class="btn btn-success"><i class="fa fa-save"></i> &nbsp;Excel</button>
                                </div> 
                            </div>
                            <table class="table" id="exportDataPenggunaan">
                                ...
                                <tr>
                                    <th colspan="13" style="text-align:center;text-transform:uppercase">TOTAL PENGGUNAAN PER-KATEGORI TAHUN {{$tahun_id}}</th>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th>Jan</th>
                                ...
                                <?php
                                    for($i=0;$i<count($nilaiPenggunaanKatA);$i++){
                                        echo '<tr>
                                                <td>'.$nilaiPenggunaanKatA[$i]['nama_kategori'].'</td>
                                            ';
                                        for($j=0;$j<12;$j++){
                                            if($nilaiPenggunaanKatA[$i]['nilai'][$j] == 0){
                                                echo'<td>-</td>';
                                            }
                                            else{

                                                echo '
                                                <td>'.$nilaiPenggunaanKatA[$i]['nilai'][$j].' Pcs</td>
                                                ';
                                            }
                                        }
                                        echo'</tr>';
...
<script>
    ...
    Highcharts.chart('chartPenggunaanKatBulanan', {
        ...
        subtitle: {
            text: 'Total Jumlah Penggunaan per-Kategori pada Cabang : <b>{{$namaCabangSort}}</b>'
        },
        xAxis: {
            categories: [ 'Jan',
            'Feb',
