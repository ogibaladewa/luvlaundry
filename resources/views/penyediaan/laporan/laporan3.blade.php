                ...
                <div class="col-md-12">
                    <div class="panel-content">
                        ...
                        <div class="row" style="border-top:5px solid #f5f5fa;">
                            &nbsp;
                                <form action="/penyediaan/laporan/penyediaan3" method="GET">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Tahun</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button style="float:right; margin-right:5px;"  onclick="exportToExcel('exportDataPenyediaan', 'LaporanPenyediaanPerBarang{{$data_bulan['nama_bulan'][$bulan_id-1]}}{{$tahun_id}}Cabang{{$namaCabangSort}}')" class="btn btn-success"><i class="fa fa-save"></i> &nbsp;Excel</button>
                                </div> 
                            </div>
                            <table class="table" id="exportDataPenyediaan">
                                ...
                                <tr>
                                    <th colspan="2" style="text-align:center;text-transform:uppercase">JUMLAH PENYEDIAAN BULAN {{$data_bulan['nama_bulan'][$bulan_id-1]}} TAHUN {{$tahun_id}} PER-BARANG</th>
                                </tr>
                                <tr>
                                ...
                                <?php
                                    for($i=0;$i<count($nilaiPenyediaanBarang);$i++){
                                        echo '<tr>
                                                <td>'.$namaBarang[$i].'</td>
                                            ';
                                            if($nilaiPenyediaanBarang[$i] == 0){
                                                echo'<td>-</td>';
                                            }
                                            else{

                                                echo '
                                                <td>'.$nilaiPenyediaanBarang[$i].' Pcs</td>
                                                ';
                                            }
...
<script>
    ...
    title: {
        text: 'Jumlah Penyediaan Bulan {{$data_bulan['nama_bulan'][$bulan_id-1]}} Tahun {{$tahun_id}} per-Barang'
    },
